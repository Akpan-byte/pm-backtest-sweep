# CHANGE_SUMMARY
# 2026-08-14  coder
#   - REWRITTEN as the FUTURES/normal-trading version of Blueprint 4.
...
#     max_entry_price, time_gate_seconds). 08:00 ET lock, BPR/DIRTY_BPR
#     detection, orderflow FVG confirmation, 2-pip/5-pip risk (pip_value maps
#     pips to points), and counter-trend halving are unchanged.
#   - The Polymarket-flavored original is archived verbatim in
#     strategies/signals_polymarket/post_8am_bpr_magnet.py.
...
"""Blueprint 4 (FUTURES): Post-8AM BPR Magnet (Orderflow Micro-Scalp).
...
Signal kwargs:
  ...
  pip_value     : price units per pip for the asset (default 1.0 = 1 point)
"""
...
def post_8am_bpr_magnet(
    ...
    **kwargs,
    ...
    direction = "LONG" if tf_trend == "BULLISH" else "SHORT"
